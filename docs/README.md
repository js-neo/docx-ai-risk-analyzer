...
Codex не должен подключаться к полноценной реализации до появления и approval отдельных workflow-документов:
...
`docs/workflow/github-pr-orchestration.md` описывает PR workflow. Codex-specific implementation rules and prompt templates должны оставаться отдельными документами.
